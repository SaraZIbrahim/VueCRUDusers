<template>
  <div class="home">
    <h3 class="heading">Users Data</h3>
    <div>
      <b-row>
    ...
    <div style="float:right;margin:10px;">
      <b-button size="sm" @click="addEmployee">Add New User</b-button>
    </div>
...
export default {
  ...
  data () {
    return {
      fields: [
        {
          key: 'fn', label: 'First Name', sortable: true, class: 'text-center'
        },
        {
          key: 'ln', label: 'Last Name', sortable: true, class: 'text-center'
        },
        {
